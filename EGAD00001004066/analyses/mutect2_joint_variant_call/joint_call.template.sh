...
wgs_calling_regions="../../../common_data/ref/wgs_calling_regions.hg38.interval_list"

# GATK Resource Bundle Files
panel_of_normals="../../../common_data/gatk-best-practices/somatic-hg38/1000g_pon.hg38.vcf.gz"
germline_resource="../../../common_data/gatk-best-practices/somatic-hg38/af-only-gnomad.hg38.vcf.gz"
# This VCF is used for GetPileupSummaries to check for contamination at common variant sites
contamination_vcf="../../../common_data/gatk-best-practices/somatic-hg38/small_exac_common_3.hg38.vcf.gz"
