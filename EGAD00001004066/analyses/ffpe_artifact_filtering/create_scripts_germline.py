...
vcf_paths = glob.glob("../../data/germline_vcf/*/*.vcf.gz")
filtered_outdir = "../../ffpe-snvf/germline_vcf"
...
for vcf_path in vcf_paths:
    ...
    for model in models:
        content = f"#!/bin/bash\nbash ../{model}.sh.template '../../../data/bam/{sample_name}/{sample_name}.bam' '../{vcf_path}' '../{filtered_outdir}'\n"
