...
## This script contains functions for evaluation and plotting
## This is an initial draft and needs drastic refinement to be generalizable across multiple projects and datasets
